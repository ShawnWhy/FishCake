...
var flagDrop= function(value,pole){
    switch( value){
        case '1':
            var flag=$('<div>')
            flag.addClass('flag')
            flag.html('<ul class="list"><li class="listItem">Cake</li><li class="listItem">Cake</li></ul>')
            $('.pole').append(flag)
        ...
        case '2':
            var flag=$('<div>')
            flag.addClass('flag')
            flag.html('<ul class="list"><li class="listItem">Fish</li><li class="listItem">Cake</li></ul>')
            $('.pole').append(flag)
        ...
        case '3':
            var flag=$('<div>')
            flag.addClass('flag')
            flag.html('<ul class="list"><li class="listItem">Fish</li></ul>')
            $('.pole').append(flag)
        ...
        case '4':
            var flag=$('<div>')
            flag.addClass('flag')
            flag.html('<ul class="list"><li class="listItem">Cake</li><li class="listItem">Fish</li></ul>')
            $('.pole').append(flag)
...
$('.secOne').mouseover(event=>{
    $('.capFront').html('<p>Dood</p>')
    
    
})
$('.secTwo').mouseover(event=>{
    $('.capFront').html('<p>Look</p>')
 
})
$('.secThree').mouseover(event=>{
    $('.capFront').html('<p>Snoop</p>')
  
})
$('.secFour').mouseover(event=>{
    $('.capFront').html('<p>Estrogon<br>Vladimir</p>')
